package br.com.jacotei.api.v1.client;
...
import br.com.jacotei.api.v1.client.auth.Authentication;
import br.com.jacotei.api.v1.client.auth.HttpBasicAuth;
import br.com.jacotei.api.v1.client.auth.ApiKeyAuth;
import br.com.jacotei.api.v1.client.auth.OAuth;

public class ApiClient {
	private Map<String, Client> hostMap = new HashMap<String, Client>();
	private Map<String, String> defaultHeaderMap = new HashMap<String, String>();
	private boolean debugging = false;
	private String basePath = "https://webapisb.jacotei.com.br/publisher/v1";
